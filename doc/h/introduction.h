...
@page inlib_minuit_introduction Introduction
  ...
  inlib_minuit is the collection of exlib examples related to Python put in a standalone package
 and distribution.
 ...
 these use the SWIG wrapping of some (but not all) classes of inlib and exlib.
  ...
  C++ apps (in 1.0.0) (source code in inlib_minuit/inexlib/exlib/examples/cpp) :
@verbatim
